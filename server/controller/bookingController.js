...
//     const booking = await Room.findById(propertyId);
//     if (!booking) {
...
//       return res.status(400).json({ success: false, message: 'Payment not verified or failed' });
//     }
//     // console.log("it remain updating here");
...
//     newbooking.hotel = booking.hotel.name;
//     newbooking.room = user;
//     newbooking.user = user;
//     newbooking.isPaid = true;
//     newbooking.paymentMethod = "Flutterwave";
//     newbooking.status = 'confirmed'; 
//     newbooking.transaction_id = data.transaction_id; 
 

//     await booking.save();

//     return res.status(200).json({ success: true, message: 'Payment verified and booking updated', booking });
...
// export const PayFlutterwave = async () => {
//     try {
...
//         const stripeInstance = new stripe(process.eventNames.stripe_secret);
