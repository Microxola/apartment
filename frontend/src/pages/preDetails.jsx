...
const ListingDetails = () => {
  ...
  const carouselImages = [
    "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=900&q=80",
    "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=900&q=80",
    "https://images.unsplash.com/photo-1600566753053-8f5dbe354819?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=900&q=80",
    "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=900&q=80",
    "https://images.unsplash.com/photo-1600585154526-990dced4db0d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=900&q=80"
  ];

  const thumbnailImages = [
    "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=300&q=80",
    "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=300&q=80",
    "https://images.unsplash.com/photo-1600566753053-8f5dbe354819?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=300&q=80",
    "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=300&q=80",
    "https://images.unsplash.com/photo-1600585154526-990dced4db0d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=300&q=80"
  ];
  ...
  const amenities = [
    "A/C & Heating", "Garages", "Swimming Pool", "Parking", 
    "Garden", "Disabled Access", "Pet Friendly", "Ceiling Height",
    "Refrigerator", "Fireplace", "Elevator", "Wifi"
  ];

  const floorPlans = [
    { floor: "1st Floor", sqft: "1370", bed: "03", bath: "02", active: true },
    { floor: "2nd Floor", sqft: "1145", bed: "02", bath: "02", active: false },
    { floor: "3rd Floor", sqft: "1245", bed: "02", bath: "01", active: false }
  ];

  const nearbyItems = [
    { name: "School & Collage:", distance: "0.9km" },
  ...
  const similarHomes = [
    { title: "Blueberry villa.", address: "Mirpur 10, Stadium dhaka", price: "$34,900", status: "FOR RENT", image: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&q=80" },
    { title: "White House villa", address: "California link road, ca, usa", price: "$28,100", status: "FOR SELL", image: "https://images.unsplash.com/photo-1600566753053-8f5dbe354819?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&q=80" },
    { title: "Luxury villa in Dal lake.", address: "Mirpur 10, Stadium", price: "$42,500", status: "FOR SELL", image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&q=80" }
  ];

  const [activeFloor, setActiveFloor] = useState(0);
  useEffect(() => {
        const property = rooms.find(room => room._id === id);
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap">
          <div className="w-full lg:w-1/2">
            <h3 className="text-6xl font-bold text-gray-900">Luxury Apartments on California.</h3>
            <div className="flex flex-wrap mt-3">
              <div className="uppercase bg-gray-200 text-gray-800 px-4 py-1 rounded-full text-sm font-medium mt-3 mr-3">FOR SELL</div>
          ...
          <div className="w-full lg:w-1/2 text-right mt-10 lg:mt-0">
            <div className="inline-block md:mt-10">
              <div className="text-4xl font-medium text-gray-900">Price: $1,67,000</div>
        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full xl:w-8/12 px-4">
              ...
              <div className="mt-10">
                <ul className="flex flex-wrap justify-between">
                  <li className="flex items-center mb-5 w-full sm:w-1/2 lg:w-1/4">
                    ...
                    <span className="text-xl font-medium text-gray-900">Sqft . 3,720</span>
                  </li>
                  <li className="flex items-center mb-5 w-full sm:w-1/2 lg:w-1/4">
                    <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center mr-3">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-xl font-medium text-gray-900">Bed . 03</span>
                  </li>
                  <li className="flex items-center mb-5 w-full sm:w-1/2 lg:w-1/4">
                    <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center mr-3">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-xl font-medium text-gray-900">Bath . 2</span>
                  </li>
                  <li className="flex items-center mb-5 w-full sm:w-1/2 lg:w-1/4">
                    <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center mr-3">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <span className="text-xl font-medium text-gray-900">Kitchen . 01</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="feature-list-two">
                <ul className="flex flex-wrap justify-between">
                  {propertyFeatures.map((feature, index) => (
                    <li key={index} className="w-full sm:w-1/2 mb-4">
            ...
            {/* Floor Plans */}
            <div className="bg-white shadow-lg rounded-2xl p-8 mb-8 border-t">
              <h4 className="text-2xl font-bold mb-8">Floor Plans</h4>
              <div className="mt-10">
                <div className="accordion">
                  {floorPlans.map((plan, index) => (
                    <div key={index} className="accordion-item mb-4 border rounded-lg overflow-hidden">
                      <button 
                        className={`accordion-button w-full text-left p-4 bg-gray-50 flex justify-between items-center ${plan.active ? 'bg-blue-50' : ''}`}
                        onClick={() => setActiveFloor(index)}
                      >
                        <span className="font-medium text-gray-900">{plan.floor}</span>
                        <ul className="flex flex-wrap items-center justify-between">
                          <li className="flex items-center mx-4">
                            ...
                            <span><span className="font-medium">{plan.sqft}</span> sqft</span>
                          </li>
                          <li className="flex items-center mx-4">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-600 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01" />
                            </svg>
                            <span><span className="font-medium">{plan.bed}</span> bed</span>
                          </li>
                          <li className="flex items-center mx-4">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-600 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                            ...
                            <span><span className="font-medium">{plan.bath}</span> bath</span>
                          </li>
                        </ul>
                      </button>
                      {activeFloor === index && (
                        <div className="accordion-collapse p-4">
                          <img 
                            src="https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=900&q=80" 
                            alt="Floor plan" 
              ...
              <ul className="flex flex-wrap justify-between">
                {nearbyItems.map((item, index) => (
                  <li key={index} className="w-full sm:w-1/2 lg:w-1/3 mb-4">
                    {item.name} <span className="font-medium text-gray-900">{item.distance}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="bg-white shadow-lg rounded-2xl p-8 mb-8 border-t">
              ...
              <div className="similar-listing-slider-two grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div key={index} className="border rounded-2xl overflow-hidden">
                    <div className="p-4">
                      <div className="relative rounded-xl overflow-hidden">
                        ...
                        <img src={home.image} alt={home.title} className="w-full h-48 object-cover rounded-xl" />
                        <a href="#" className="absolute bottom-4 right-4 bg-white rounded-full p-2 shadow-md">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="p-4 pt-0">
                      <a href="#" className="text-lg font-semibold text-gray-900 hover:text-[#ff6725] transition-colors">{home.title}</a>
                      <div className="text-gray-600 mt-1">{home.address}</div>
                      <div className="flex justify-between items-center mt-4">
                        <strong className="text-lg font-medium text-gray-900">{home.price}</strong>
                        <ul className="flex">
                          <li className="ml-2">
          ...
          <div className="w-full xl:w-4/12 px-4 mt-12 xl:mt-0">
            ...
            <div className="bg-white rounded-2xl p-6 mb-8">
              <div className="text-center">
                ...
                />
                <div className="mt-6">
                  <h6 className="text-lg font-semibold">Rashed Kabir</h6>
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex justify-between">
                      ...
                      <span className="font-medium">
                        <a href="mailto:akabirr770@gmail.com" className="text-[#ff6725]">akabirr770@gmail.com</a>
                      </span>
                    </li>
                    <li className="flex justify-between">
                      <span>Phone:</span> 
                      <span className="font-medium">
                        <a href="tel:+12347687565" className="text-[#ff6725]">+12347687565</a>
                      </span>
                    </li>
                  </ul>
                </div>
