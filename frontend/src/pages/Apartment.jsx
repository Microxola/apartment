...
const Apartment = () => {
  ...
  return (
    <div className="bg-[#F5EDE8] md:pt-20 pb-40 xl:pb-30">
      <div className="container mx-auto px-4">  
       ...
       {/* <div className="block sm:hidden rounded-2xl w-full">
          <div className="p-6">
            <form>
              <div className="flex justify-between gap-4 items-center border border-amber-200 ">
                <div className="input-box border-l border-gray-200">
                  <div className="label text-sm text-gray-500">I'm looking...</div>
                  <select 
                    name="propertyType"
                    value={filters.propertyType}
                    onChange={handleFilterChange}
    ...
    <div className="flex justify-between items-center gap-2 mt-10">
      ...
      <div className="flex-1 bg-white border border-gray-300 rounded-md px-2 py-1">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                  {displayedRooms.filter(property => property.roomType === 'Apartment').map(property => {
                    const activeIndex = activeIndicators[property._id] || 0;
                        ...
                        <div className="listing-card border border-gray-200 rounded-2xl h-full w-full overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
                          ...
                          <div className="property-info p-4 md:p-6">
                            ...
                            <div className="pl-footer border-t border-gray-200 pt-3 md:pt-4 flex items-center justify-between">
                              ...
                              <Link to={'/details/' + property._id} onClick={() => scrollTo(0,0)} className="btn-four rounded-full text-white w-8 h-8 md:w-10 md:h-10 flex items-center justify-center bg-[#ff6725] hover:bg-[#ff6625ab] transition-colors duration-300">
                                 <svg
